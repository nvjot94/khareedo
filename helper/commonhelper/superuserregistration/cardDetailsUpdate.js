...
function start(response, carddetailsobject, userid, password) {
    ...
    schema.findOne({ 'superuser.email': userid }, (err, docs) => {
        if (err) {
            ...
            console.log("docs inside carddetailsupdate function", docs);
            ...
            if (bcrypt.compareSync(password, docs.superuser.password)) {
                ...
                docs.carddetails = carddetailsobject.carddetails;
